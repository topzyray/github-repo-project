...
const RepositoryDetails = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-10 mt-6 py-4 lg:py-10 px-6 md:px-10 lg:px-36">
      <div className="flex flex-col gap-5 max-w-3xl mx-auto">
        ...
        {repo && (
          <div className="flex flex-col md:flex-row gap-8 h-full">
            {/* Owner's information */}
            <div>
              <h3 className="font-semibold text-base sm:text-lg underline mb-3">
                Owner's Information:
              </h3>
      ...
      <Link to="/" className="underline hover:underline font-semibold mt-6">
        Back to Repo Lists
      </Link>
    </div>
  );
